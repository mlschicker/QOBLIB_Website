...
| # Decision Variables | 756 |
| # Binary Variables | 756 |
...
| ====== |  |
| Total Runtime | 2.59E-01 |
| Time to Solution | N/A |
| CPU Runtime | 2.59E-01 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 756 (permutations), 0 (weights). Decision variables range: [0,1] (permutations), [0,10000] (weights). |
