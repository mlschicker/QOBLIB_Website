...
| # Decision Variables | 1375 |
| # Binary Variables | 1375 |
| # Integer Variables | 55 |
| # Continuous Variables | 0 |
| # Non-Zero Coefficients | 605 |
...
| ====== |  |
| Remarks | Decision variable breakdown: 1375 (permutations), 0 (weights). Decision variables range: [0,1] (permutations), [0,10000] (weights). |
