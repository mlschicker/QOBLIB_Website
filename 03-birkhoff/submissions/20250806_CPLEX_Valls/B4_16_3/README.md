...
| # Decision Variables | 576 |
| # Binary Variables | 576 |
...
| ====== |  |
| Total Runtime | 2.84E+00 |
| Time to Solution | N/A |
| CPU Runtime | 2.84E+00 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 576 (permutations), 0 (weights). Decision variables range: [0,1] (permutations), [0,10000] (weights). |
