...
| ====== |  |
| Total Runtime | 1.05E-01 |
| Time to Solution | N/A |
| CPU Runtime | 1.05E-01 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 135 (permutations), 0 (weights). Decision variables range: [0,1] (permutations), [0,10000] (weights). |
