...
| ====== |  |
| Total Runtime | 2.85E+01 |
| Time to Solution | N/A |
| CPU Runtime | 2.85E+01 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 720 (permutations), 0 (weights). Decision variables range: [0,1] (permutations), [0,10000] (weights). |
