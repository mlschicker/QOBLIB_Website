...
| # Decision Variables | 2880 |
| # Binary Variables | 2880 |
| # Integer Variables | 45 |
| # Continuous Variables | 0 |
| # Non-Zero Coefficients | 765 |
...
| ====== |  |
| Total Runtime | 6.79E+01 |
| Time to Solution | N/A |
| CPU Runtime | 6.79E+01 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 2880 (permutations), 0 (weights). Decision variables range: [0,1] (permutations), [0,10000] (weights). |
