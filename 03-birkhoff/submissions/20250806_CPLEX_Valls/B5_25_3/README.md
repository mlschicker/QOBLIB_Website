...
| # Decision Variables | 900 |
| # Binary Variables | 900 |
| # Integer Variables | 36 |
| # Continuous Variables | 0 |
| # Non-Zero Coefficients | 396 |
...
| ====== |  |
| Remarks | Decision variable breakdown: 900 (permutations), 0 (weights). Decision variables range: [0,1] (permutations), [0,10000] (weights). |
