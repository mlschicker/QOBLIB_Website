...
| # Decision Variables | 22873 |
| # Binary Variables | 22784 |
...
| ====== |  |
| Total Runtime | 9.58E-02 |
| Time to Solution | N/A |
| CPU Runtime | 9.58E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 22784 (permutations), 89 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
