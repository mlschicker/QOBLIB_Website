...
| # Decision Variables | 4758 |
| # Binary Variables | 4719 |
...
| ====== |  |
| Total Runtime | 2.10E-02 |
| Time to Solution | N/A |
| CPU Runtime | 2.10E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 4719 (permutations), 39 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
