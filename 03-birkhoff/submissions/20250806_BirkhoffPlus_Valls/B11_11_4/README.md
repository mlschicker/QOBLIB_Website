...
| # Decision Variables | 2074 |
| # Binary Variables | 2057 |
...
| ====== |  |
| Total Runtime | 9.91E-03 |
| Time to Solution | N/A |
| CPU Runtime | 9.91E-03 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 2057 (permutations), 17 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
