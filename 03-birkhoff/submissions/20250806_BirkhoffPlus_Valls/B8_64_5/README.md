...
| # Decision Variables | 2405 |
| # Binary Variables | 2368 |
...
| ====== |  |
| Total Runtime | 1.97E-02 |
| Time to Solution | N/A |
| CPU Runtime | 1.97E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 2368 (permutations), 37 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
