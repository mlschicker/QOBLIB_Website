...
| # Decision Variables | 23130 |
| # Binary Variables | 23040 |
...
| ====== |  |
| Total Runtime | 9.87E-02 |
| Time to Solution | N/A |
| CPU Runtime | 9.87E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 23040 (permutations), 90 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
