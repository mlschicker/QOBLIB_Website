...
| # Decision Variables | 1414 |
| # Binary Variables | 1400 |
...
| ====== |  |
| Total Runtime | 7.48E-03 |
| Time to Solution | N/A |
| CPU Runtime | 7.48E-03 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 1400 (permutations), 14 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
