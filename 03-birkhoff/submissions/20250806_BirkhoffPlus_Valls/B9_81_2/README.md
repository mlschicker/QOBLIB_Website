...
| # Decision Variables | 3362 |
| # Binary Variables | 3321 |
...
| ====== |  |
| Total Runtime | 2.28E-02 |
| Time to Solution | N/A |
| CPU Runtime | 2.28E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 3321 (permutations), 41 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
