...
| # Decision Variables | 8670 |
| # Binary Variables | 8619 |
...
| ====== |  |
| Total Runtime | 3.80E-02 |
| Time to Solution | N/A |
| CPU Runtime | 3.80E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 8619 (permutations), 51 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
