...
| # Decision Variables | 962 |
| # Binary Variables | 936 |
...
| ====== |  |
| Total Runtime | 1.08E-02 |
| Time to Solution | N/A |
| CPU Runtime | 1.08E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 936 (permutations), 26 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
