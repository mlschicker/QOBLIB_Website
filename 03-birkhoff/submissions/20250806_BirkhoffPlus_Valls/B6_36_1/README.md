...
| # Decision Variables | 925 |
| # Binary Variables | 900 |
...
| ====== |  |
| Total Runtime | 1.12E-02 |
| Time to Solution | N/A |
| CPU Runtime | 1.12E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 900 (permutations), 25 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
