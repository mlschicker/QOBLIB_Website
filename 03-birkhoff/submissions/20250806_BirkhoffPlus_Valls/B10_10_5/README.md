...
| # Decision Variables | 2323 |
| # Binary Variables | 2300 |
...
| ====== |  |
| Total Runtime | 1.20E-02 |
| Time to Solution | N/A |
| CPU Runtime | 1.20E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 2300 (permutations), 23 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
