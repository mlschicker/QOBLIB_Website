...
| # Decision Variables | 18758 |
| # Binary Variables | 18675 |
...
| ====== |  |
| Total Runtime | 8.39E-02 |
| Time to Solution | N/A |
| CPU Runtime | 8.39E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 18675 (permutations), 83 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
