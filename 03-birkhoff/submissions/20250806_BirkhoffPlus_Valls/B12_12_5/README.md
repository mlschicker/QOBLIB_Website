...
| # Decision Variables | 4930 |
| # Binary Variables | 4896 |
...
| ====== |  |
| Total Runtime | 2.21E-02 |
| Time to Solution | N/A |
| CPU Runtime | 2.21E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 4896 (permutations), 34 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
