...
| # Decision Variables | 8274 |
| # Binary Variables | 8232 |
...
| ====== |  |
| Total Runtime | 3.04E-02 |
| Time to Solution | N/A |
| CPU Runtime | 3.04E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 8232 (permutations), 42 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
