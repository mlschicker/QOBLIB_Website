...
| # Decision Variables | 520 |
| # Binary Variables | 512 |
| # Integer Variables | 8 |
...
| ====== |  |
| Total Runtime | 4.00E-03 |
| Time to Solution | N/A |
| CPU Runtime | 4.00E-03 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 512 (permutations), 8 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
