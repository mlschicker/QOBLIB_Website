...
| # Decision Variables | 10005 |
| # Binary Variables | 9936 |
...
| ====== |  |
| Total Runtime | 5.41E-02 |
| Time to Solution | N/A |
| CPU Runtime | 5.41E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 9936 (permutations), 69 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
