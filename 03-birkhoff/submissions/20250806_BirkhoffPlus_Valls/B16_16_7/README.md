...
| # Decision Variables | 15420 |
| # Binary Variables | 15360 |
...
| ====== |  |
| Total Runtime | 5.56E-02 |
| Time to Solution | N/A |
| CPU Runtime | 5.56E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 15360 (permutations), 60 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
