...
| # Decision Variables | 2050 |
| # Binary Variables | 2025 |
...
| ====== |  |
| Total Runtime | 1.17E-02 |
| Time to Solution | N/A |
| CPU Runtime | 1.17E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 2025 (permutations), 25 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
