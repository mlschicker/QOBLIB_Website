...
| # Decision Variables | 18984 |
| # Binary Variables | 18900 |
...
| ====== |  |
| Total Runtime | 8.35E-02 |
| Time to Solution | N/A |
| CPU Runtime | 8.35E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 18900 (permutations), 84 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
