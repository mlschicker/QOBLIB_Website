...
| # Decision Variables | 13108 |
| # Binary Variables | 13050 |
...
| ====== |  |
| Total Runtime | 4.87E-02 |
| Time to Solution | N/A |
| CPU Runtime | 4.87E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 13050 (permutations), 58 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
