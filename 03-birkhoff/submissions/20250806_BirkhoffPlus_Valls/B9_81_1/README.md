...
| # Decision Variables | 3444 |
| # Binary Variables | 3402 |
...
| ====== |  |
| Total Runtime | 2.30E-02 |
| Time to Solution | N/A |
| CPU Runtime | 2.30E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 3402 (permutations), 42 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
