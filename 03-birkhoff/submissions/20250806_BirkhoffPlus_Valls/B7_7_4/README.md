...
| # Decision Variables | 550 |
| # Binary Variables | 539 |
...
| ====== |  |
| Total Runtime | 5.04E-03 |
| Time to Solution | N/A |
| CPU Runtime | 5.04E-03 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 539 (permutations), 11 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
