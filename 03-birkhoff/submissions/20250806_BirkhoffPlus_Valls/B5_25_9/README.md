...
| ====== |  |
| Total Runtime | 6.59E-03 |
| Time to Solution | N/A |
| CPU Runtime | 6.59E-03 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 400 (permutations), 16 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
