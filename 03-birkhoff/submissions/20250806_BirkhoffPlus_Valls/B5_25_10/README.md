...
| ====== |  |
| Total Runtime | 7.70E-03 |
| Time to Solution | N/A |
| CPU Runtime | 7.70E-03 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 425 (permutations), 17 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
