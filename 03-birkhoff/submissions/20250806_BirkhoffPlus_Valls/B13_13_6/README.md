...
| # Decision Variables | 8500 |
| # Binary Variables | 8450 |
...
| ====== |  |
| Total Runtime | 3.33E-02 |
| Time to Solution | N/A |
| CPU Runtime | 3.33E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 8450 (permutations), 50 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
