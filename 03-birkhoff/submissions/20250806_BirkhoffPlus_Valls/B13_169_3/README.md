...
| # Decision Variables | 12750 |
| # Binary Variables | 12675 |
...
| ====== |  |
| Total Runtime | 6.20E-02 |
| Time to Solution | N/A |
| CPU Runtime | 6.20E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 12675 (permutations), 75 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
