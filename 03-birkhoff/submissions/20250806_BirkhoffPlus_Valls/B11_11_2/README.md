...
| # Decision Variables | 3782 |
| # Binary Variables | 3751 |
...
| ====== |  |
| Total Runtime | 1.65E-02 |
| Time to Solution | N/A |
| CPU Runtime | 1.65E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 3751 (permutations), 31 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
