...
| # Decision Variables | 333 |
| # Binary Variables | 324 |
| # Integer Variables | 9 |
...
| ====== |  |
| Total Runtime | 4.15E-03 |
| Time to Solution | N/A |
| CPU Runtime | 4.15E-03 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 324 (permutations), 9 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
