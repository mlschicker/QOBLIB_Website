...
| # Decision Variables | 650 |
| # Binary Variables | 637 |
...
| ====== |  |
| Total Runtime | 5.59E-03 |
| Time to Solution | N/A |
| CPU Runtime | 5.59E-03 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 637 (permutations), 13 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
