...
| # Decision Variables | 4760 |
| # Binary Variables | 4732 |
...
| ====== |  |
| Total Runtime | 1.81E-02 |
| Time to Solution | N/A |
| CPU Runtime | 1.81E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 4732 (permutations), 28 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
