...
| # Decision Variables | 15677 |
| # Binary Variables | 15616 |
...
| ====== |  |
| Total Runtime | 5.47E-02 |
| Time to Solution | N/A |
| CPU Runtime | 5.47E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 15616 (permutations), 61 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
