...
| # Decision Variables | 12656 |
| # Binary Variables | 12600 |
...
| ====== |  |
| Total Runtime | 4.59E-02 |
| Time to Solution | N/A |
| CPU Runtime | 4.59E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 12600 (permutations), 56 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
