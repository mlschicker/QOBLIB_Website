...
| # Decision Variables | 7808 |
| # Binary Variables | 7744 |
...
| ====== |  |
| Remarks | Decision variable breakdown: 7744 (permutations), 64 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
