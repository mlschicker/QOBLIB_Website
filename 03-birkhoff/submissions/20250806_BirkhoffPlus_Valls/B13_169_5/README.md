...
| # Decision Variables | 12240 |
| # Binary Variables | 12168 |
...
| ====== |  |
| Total Runtime | 6.03E-02 |
| Time to Solution | N/A |
| CPU Runtime | 6.03E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 12168 (permutations), 72 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
