...
| # Decision Variables | 6815 |
| # Binary Variables | 6768 |
...
| ====== |  |
| Total Runtime | 3.20E-02 |
| Time to Solution | N/A |
| CPU Runtime | 3.20E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 6768 (permutations), 47 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
