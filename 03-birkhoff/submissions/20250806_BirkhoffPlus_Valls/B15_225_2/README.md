...
| # Decision Variables | 19210 |
| # Binary Variables | 19125 |
...
| ====== |  |
| Total Runtime | 8.44E-02 |
| Time to Solution | N/A |
| CPU Runtime | 8.44E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 19125 (permutations), 85 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
