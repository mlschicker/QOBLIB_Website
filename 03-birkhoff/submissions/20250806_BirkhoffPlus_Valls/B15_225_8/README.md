...
| # Decision Variables | 19436 |
| # Binary Variables | 19350 |
...
| ====== |  |
| Total Runtime | 8.29E-02 |
| Time to Solution | N/A |
| CPU Runtime | 8.29E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 19350 (permutations), 86 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
