...
| # Decision Variables | 1616 |
| # Binary Variables | 1600 |
...
| ====== |  |
| Total Runtime | 8.64E-03 |
| Time to Solution | N/A |
| CPU Runtime | 8.64E-03 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 1600 (permutations), 16 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
