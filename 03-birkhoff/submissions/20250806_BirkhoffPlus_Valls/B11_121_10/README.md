...
| # Decision Variables | 7320 |
| # Binary Variables | 7260 |
...
| ====== |  |
| Total Runtime | 4.19E-02 |
| Time to Solution | N/A |
| CPU Runtime | 4.19E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 7260 (permutations), 60 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
