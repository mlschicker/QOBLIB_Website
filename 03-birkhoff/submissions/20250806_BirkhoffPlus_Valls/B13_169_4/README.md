...
| # Decision Variables | 12580 |
| # Binary Variables | 12506 |
...
| ====== |  |
| Total Runtime | 5.91E-02 |
| Time to Solution | N/A |
| CPU Runtime | 5.91E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 12506 (permutations), 74 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
