...
| # Decision Variables | 5656 |
| # Binary Variables | 5600 |
...
| ====== |  |
| Total Runtime | 3.87E-02 |
| Time to Solution | N/A |
| CPU Runtime | 3.87E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 5600 (permutations), 56 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
