...
| # Decision Variables | 1313 |
| # Binary Variables | 1300 |
...
| ====== |  |
| Total Runtime | 9.35E-03 |
| Time to Solution | N/A |
| CPU Runtime | 9.35E-03 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 1300 (permutations), 13 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
