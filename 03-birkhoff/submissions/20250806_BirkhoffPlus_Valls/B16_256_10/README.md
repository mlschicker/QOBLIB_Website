...
| # Decision Variables | 23387 |
| # Binary Variables | 23296 |
...
| ====== |  |
| Total Runtime | 1.02E-01 |
| Time to Solution | N/A |
| CPU Runtime | 1.02E-01 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 23296 (permutations), 91 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
