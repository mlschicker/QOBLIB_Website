...
| # Decision Variables | 1476 |
| # Binary Variables | 1458 |
...
| ====== |  |
| Total Runtime | 9.01E-03 |
| Time to Solution | N/A |
| CPU Runtime | 9.01E-03 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 1458 (permutations), 18 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
