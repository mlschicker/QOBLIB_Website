...
| # Decision Variables | 10622 |
| # Binary Variables | 10575 |
...
| ====== |  |
| Total Runtime | 3.55E-02 |
| Time to Solution | N/A |
| CPU Runtime | 3.55E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 10575 (permutations), 47 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
