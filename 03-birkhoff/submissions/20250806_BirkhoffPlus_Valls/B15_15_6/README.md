...
| # Decision Variables | 13786 |
| # Binary Variables | 13725 |
...
| ====== |  |
| Total Runtime | 5.15E-02 |
| Time to Solution | N/A |
| CPU Runtime | 5.15E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 13725 (permutations), 61 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
