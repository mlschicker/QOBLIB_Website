...
| # Decision Variables | 738 |
| # Binary Variables | 729 |
| # Integer Variables | 9 |
...
| ====== |  |
| Total Runtime | 5.42E-03 |
| Time to Solution | N/A |
| CPU Runtime | 5.42E-03 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 729 (permutations), 9 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
