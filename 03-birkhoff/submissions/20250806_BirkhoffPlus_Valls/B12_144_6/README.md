...
| # Decision Variables | 9715 |
| # Binary Variables | 9648 |
...
| ====== |  |
| Total Runtime | 5.20E-02 |
| Time to Solution | N/A |
| CPU Runtime | 5.20E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 9648 (permutations), 67 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
