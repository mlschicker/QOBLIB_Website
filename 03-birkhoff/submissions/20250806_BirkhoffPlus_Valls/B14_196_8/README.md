...
| # Decision Variables | 15760 |
| # Binary Variables | 15680 |
...
| ====== |  |
| Total Runtime | 7.72E-02 |
| Time to Solution | N/A |
| CPU Runtime | 7.72E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 15680 (permutations), 80 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
