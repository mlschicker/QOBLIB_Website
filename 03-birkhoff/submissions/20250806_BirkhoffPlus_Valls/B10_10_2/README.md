...
| # Decision Variables | 3939 |
| # Binary Variables | 3900 |
...
| ====== |  |
| Total Runtime | 2.08E-02 |
| Time to Solution | N/A |
| CPU Runtime | 2.08E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 3900 (permutations), 39 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
