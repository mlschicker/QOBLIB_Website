...
| # Decision Variables | 14012 |
| # Binary Variables | 13950 |
...
| ====== |  |
| Total Runtime | 5.19E-02 |
| Time to Solution | N/A |
| CPU Runtime | 5.19E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 13950 (permutations), 62 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
