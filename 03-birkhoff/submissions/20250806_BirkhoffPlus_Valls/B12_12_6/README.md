...
| # Decision Variables | 7105 |
| # Binary Variables | 7056 |
...
| ====== |  |
| Remarks | Decision variable breakdown: 7056 (permutations), 49 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
