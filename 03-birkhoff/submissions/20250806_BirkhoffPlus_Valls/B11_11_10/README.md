...
| # Decision Variables | 2562 |
| # Binary Variables | 2541 |
...
| ====== |  |
| Total Runtime | 1.10E-02 |
| Time to Solution | N/A |
| CPU Runtime | 1.10E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 2541 (permutations), 21 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
