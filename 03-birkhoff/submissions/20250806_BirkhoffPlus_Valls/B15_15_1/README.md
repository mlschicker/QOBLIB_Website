...
| # Decision Variables | 12204 |
| # Binary Variables | 12150 |
...
| ====== |  |
| Total Runtime | 4.43E-02 |
| Time to Solution | N/A |
| CPU Runtime | 4.43E-02 |
| GPU Runtime | N/A |
| QPU Runtime | N/A |
| Other HW Runtime | N/A |
| ====== |  |
| Remarks | Decision variable breakdown: 12150 (permutations), 54 (weights). Decision variables range: [0,1] (permutations), [0,1] (weights). |
