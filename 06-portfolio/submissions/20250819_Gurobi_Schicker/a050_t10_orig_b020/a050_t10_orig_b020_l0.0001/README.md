# Submission for a050_t10_orig_b020_l0.0001

This directory contains the submission for the problem **a050_t10_orig_b020_l0.0001**.

| Field | Value 1 |
| --- | --- |
| Problem | a050_t10_orig_b020_l0.0001 |
| Submitter | Maximilian Schicker |
| Affiliation | Zuse Institute Berlin |
| Date | 2025-08-19 17:32:12 |
| ====== |  |
| Reference | See Models Directory using Gurobi 12.0.1 |
| Best Objective Value | -370869.0 |
| Optimality Bound | -378750.5018534 |
| ====== |  |
| Modeling Approach | Binary Linear Program |
| # Decision Variables | 3010 |
| # Binary Variables | 3000 |
