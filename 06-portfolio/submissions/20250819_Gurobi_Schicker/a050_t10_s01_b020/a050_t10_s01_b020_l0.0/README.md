# Submission for a050_t10_s01_b020_l0.0

This directory contains the submission for the problem **a050_t10_s01_b020_l0.0**.

| Field | Value 1 |
| --- | --- |
| Problem | a050_t10_s01_b020_l0.0 |
| Submitter | Maximilian Schicker |
| Affiliation | Zuse Institute Berlin |
| Date | 2025-08-19 20:03:12 |
| ====== |  |
| Reference | See Models Directory using Gurobi 12.0.1 |
| Best Objective Value | -431905.0 |
| Optimality Bound | -431905.0 |
| ====== |  |
